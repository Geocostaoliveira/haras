...
<head>
    ...
    <title>Haras Prime - Cavalo não encontrado</title>
...
<body>
    <div class="container">
        ...
        <h1>Cavalo não encontrado</h1>
        
        <div class="error-message">
            <p>Ainda não conhecemos esse cavalo para ser seu novo amigo :/ <br> 
            Tente digitar novamente, ou então, pesquisar outras opções de cavalos para te acompanhar!</p>
        </div>

        <div class="actions">
            <a href="index.php">← Voltar à Busca</a>
        </div>
    </div>
</body>
</html>